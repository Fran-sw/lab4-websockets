...
public class ElizaServerTest {
	...
	public void onChat() throws DeploymentException, IOException, URISyntaxException, InterruptedException {
		...
		session.getAsyncRemote().sendText("hello doc!");	// We start the conversation
		...
		//we can chat with Eliza

		session.getAsyncRemote().sendText("bye");			// We close the chat
		Thread.sleep(50);									//Wait for the response
		assertEquals(5,list.size());						// Check it has replied to us
	}
